...
class IonSelectSearchDirective {
    ...
    createInputElement() {
        ...
        input.setAttribute('placeholder', this.elementRef.nativeElement.hasAttribute('searchPlaceholder') ? this.elementRef.nativeElement.getAttribute('searchPlaceholder') : 'Search');
